...
<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4 ">
				...
				<div class="panel-heading">Update Department Name <a class="btn btn-success btn-sm pull-right" href="listofdepartments.html"> Back </a></div>
					<div class="panel-body">
						<form:form modelAttribute="department" role="form">
							<h4 class="text-info">Update Department Name</h4>
